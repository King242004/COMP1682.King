...
const sectionAuth = [
  ...
  ...useCase({
    ...
    description: "Tạo user mới trong DB với password đã hash, trả về JWT để auto login.",
    input: [
    ...
    algorithm: [
      ...
      "    IF existing:  RETURN 400 \"Email already in use\"",
      "",
      "    // Hash password",
  ...
  ...useCase({
    ...
    algorithm: [
      ...
      "    otp = FLOOR(100000 + RANDOM() × 900000).toString()",
