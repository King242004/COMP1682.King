...
export const en = {
  ...
  home: {
    ...
    energyBalance: (eaten: string, burned: string) => `Eaten ${eaten} − burned ${burned} kcal`,
    burnIncluded: "Calories burned are included in the total above",
    min: "min",
    forYou: "For you",
    viewWeek: "View plan",
  ...
  plan: {
    ...
    redoDay: "Regenerate day plan",
    confirmTitle: "Are you sure?",
    confirmWeekMsg: "The current meals from today through the end of the week will be replaced with a new plan.",
    confirmDayMsg: "The current meals on this day will be replaced with a new menu.",
    continue: "Replace meals",
    cancel: "Cancel",
  ...
  coach: {
    ...
    intro: "I'm Coach 👋 I can suggest meals and recipes that fit your health needs, review food photos, log meals and recommend workouts. Try asking:",
  ...
  exercise: {
    title: "Log workout",
    subtitle: "Calories burned are estimated from your activity, time and weight.",
  ...
  meals: {
    ...
    logAgainHint: "Creates a new entry and keeps the original unchanged.",
    ...
    caloriesRequired: "Enter the calories",
    caloriesInvalid: "Enter a valid calorie amount",
    caloriesTooHigh: "The calorie amount seems too high",
    ...
    editMealHint: "Change the details of the meal you are viewing.",
  ...
  editProfile: {
    ...
    tastePlaceholder: "e.g. no seafood, likes chicken, less spicy...",
  ...
  progress: {
    title: "Progress",
    subtitle: (n: number) => `Your overview for the last ${n} days.`,
    subtitleMonth: "Your overview for this month.",
    range7: "7 days",
    range30: "30 days",
    rangeWeek: "Week",
    rangeMonth: "Month",
    ...
    logged: "Logged",
    burnedToday: "Burned",
    actWorkoutsToday: (n: number) => `${n} workout${n !== 1 ? "s" : ""}`,
    netToday: "Net calories",
    netSub: "Eaten − burned",
    actEaten: "Eaten",
    actBurned: "Burned",
    actNet: "Net",
    burnedTrend: "Calories burned",
    burnedTrendN: (n: number) => `Calories burned · ${n} days`,
    ...
    actWeekTarget: (n: number) => `Target ${n}/week`,
    actTrained: "Trained",
    actRest: "Rest",
  },
  ...
  community: {
    ...
    sharingWhat: "What are you sharing?",
    sharePost: "Regular post",
    mealPost: "A meal",
    sharePostHint: "This is a general post. Choose \"A meal\" if you want others to see cooking guidance or add it to their diary.",
    mealPostHint: "Give the dish a name or choose it from your diary.",
    mealDetailsMethod: "How would you like to add the dish?",
    enterDishName: "Enter dish name",
    chooseFromDiary: "Choose from diary",
    dishNameLabel: "Dish name",
    dishNamePlaceholder: "For example, chicken rice",
    dishNameRequired: "Enter at least 2 characters for the dish name.",
    mealBadge: "Meal",
    ...
    recipeReferenceNotice: "This is a general recipe for reference because the same dish can be prepared in different ways. It may not exactly match the post, so adjust the ingredients and seasoning to suit you.",
    nutritionMayVary: "Calories and nutrition can vary with ingredients and portion size.",
    photosLabel: "Photos",
    pickerRecents: "Recents",
    pickerDone: "Done",
    pickerMax: (n: number) => `You can pick up to ${n} photos.`,
    pickerProcessing: "Preparing photos...",
    pickerEmpty: "No photos here yet.",
    tryThisMeal: "Try this meal",
    howToCook: "How to make it",
  ...
  auth: {
    ...
    registrationCodeResent: "We sent a new code to your email.",
