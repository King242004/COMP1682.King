...
// Backend trả một mảng không phân trang nên dữ liệu lớn sẽ làm màn nặng dần
...
export default function MealHistoryScreen() {
  ...
  // Tự tải khi mở màn. Đi tiếp: MealsContext.tsx, rồi GET /meals/history
  // Nuốt lỗi vì Context còn giữ dữ liệu cũ, hiện bản cũ hơn là hiện màn trắng
  useEffect(() => {
    void fetchMealHistory().catch(() => {});
  }, [fetchMealHistory]);

  // Gom món thành nhóm ngày, backend đã xếp sẵn mới nhất lên đầu
  ...
  // Ra màn: các nhóm ngày, mỗi nhóm là một dãy thẻ món
  // Dùng FlatList vì nó chỉ dựng phần đang nhìn thấy, vài trăm món vẫn mượt
  return (
    <Screen padded={false}>
      <FlatList
        data={grouped}
